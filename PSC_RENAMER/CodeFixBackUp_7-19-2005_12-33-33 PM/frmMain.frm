...
Private Sub Form_Initialize()
  ...
  Dim x As Integer
  If Right(App.Path, 1) <> "\" Then strSlash = "\" Else strSlash = vbNullString
  If LenB(Dir(App.Path & strSlash & "unzip32.dll")) = 0 Then
    x = SaveResItemToDisk(101, 100, App.Path & strSlash & "unzip32.dll")
    If x <> 0 Then MsgBox "Error creating UNZIP32.DLL, a necessary file. This application needs to run from a location which allows Read/Write operations. Contact the author for more details."
  End If
  InitCommonControls
...
Private Sub lblCredits2_Click()
  ...
  RunAssociated "http://www.Planet-Source-Code.com/vb/scripts/ShowCode.asp?txtCodeId=15059&lngWId=1"
...
':)Code Fixer V3.0.9 (7/18/2005 10:36:20 AM) 17 + 346 = 363 Lines Thanks Ulli for inspiration and lots of code.
